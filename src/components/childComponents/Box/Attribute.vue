<template>
  ...
  <div class="background" v-show="elClass != 'img'">
    ...
    <div class="color-select">
      <input type="color" v-model="el.style.backgroundColor" v-if="!checked1" />
      <div class="loadImg" v-if="checked1">
    ...
    function changeTextHeight() {
      nextTick(() => {
        if (elClass.value == "text") {
          let elDom =
            document.querySelectorAll(".editorPlate .text")[elsIdx[1]];
